...
initialModel () =
    ...
    , Http.get { url = "https://raw.githubusercontent.com/TornadoTebbe/ElmTest2/main/Daten/BaumStudent.json?token=GHSAT0AAAAAAB3NMVWE7NRTQAWRUIF6KWRQY4ZZABA", expect = Http.expectJson GotFlare treeDecoder }
    )
