...
initialModel () =
    ...
    , Http.get { url = "https://raw.githubusercontent.com/TornadoTebbe/ElmTest2/main/Daten/BaumStudent.json?token=GHSAT0AAAAAAB3NMVWFTKZ7Q6JIKOAPLBVMY4ZZB4A", expect = Http.expectJson GotFlare treeDecoder }
    )
